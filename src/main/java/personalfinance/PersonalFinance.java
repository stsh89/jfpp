...
public class PersonalFinance {
    ...
    private static void testModel() throws ModelException {
        ...
        transactions.add(new Transaction(ac2, article3, 25000, new Date((new Date()).getTime() - (long) 8640000 * 30)));
        transactions.add(new Transaction(ac3, article5, 1000, new Date((new Date()).getTime() - (long) 8640000 * 30)));
        ...
        for (int i = 0; i < 50; i++) {
            ...
            Date tempDate = new Date((long) (new Date().getTime() - (long) 8640000 * 30 * Math.random()));
